...
message.channel.send(new Discord.MessageEmbed().setColor('ORANGE').setDescription(`Mesajın kanalı başarıyla ayarlandı: ${prefix}ticket gönder`))
}
...
message.channel.send(new Discord.MessageEmbed().setColor('ORANGE').setDescription(`Mesajın kanalı başarıyla sıfırlandı: ${prefix}ticket-kanal ayarla #channel`))
}// Code World 
};
exports.conf = {
  enabled: true,
