...
exports.run = async (client, message, args) => { 
  ...
  const ghosttemizle = new Discord.MessageEmbed()  
  
  .setDescription(`Temizlenecek Mesaj Miktarını Belirtmelisin!\n\n Örnek Kullanım : ${prefix}**ghosttemizle 10**`)
  .setColor("RED")
  
  return message.channel.send(ghosttemizle)
  }
...
exports.conf = {
    enabled: false,
    guildOnly: false,
    aliases: ['ghosttemizle','clear','purge','delete'],
    permLevel: 0,
}
